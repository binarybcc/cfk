...
/**
 * Request Magic Link (LEGACY REDIRECT)
 *
 * This file has been migrated to Slim Framework.
 * All requests are now redirected to /admin/auth/request-magic-link
 *
...
header('Location: ' . baseUrl('/admin/auth/request-magic-link'), true, 301);
exit;
