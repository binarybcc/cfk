...
class MagicLinkManager
{
     ...
     * @return string The unhashed token to send to user
    ...
    public static function validateToken(string $token): array|null
    {
        ...
        try {
            ...
            Connection::execute($deleteSql, ['id' => $result['id']]);
     ...
     *
     * @param int $tokenId The token ID to consume
     ...
     *
     * @param int|null $adminUserId Admin user ID or null
     * @param string $eventType Type of event
     * @param string $ipAddress Client IP address
     * @param string $userAgent Client user agent
     * @param string $result Result status (success/failed/blocked)
