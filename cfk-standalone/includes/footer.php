    ...
    <footer class="main-footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                ...
                <p class="ai-attribution">This site was created with <a href="https://claude.ai" target="_blank" rel="noopener noreferrer">Claude AI</a> under human direction. If you'd like to see what AI can do for you and your business, <a href="mailto:help@edwards-group.com">email help@edwards-group.com</a>.</p>
            </div>
        </div>
    </footer>
