    ...
    <footer class="main-footer">
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h3>Coming November 1st</h3>
                    <p>Child sponsorships open Saturday, November 1, 2025 at 12:01 AM ET.</p>
                    <p>Monetary donations are being accepted now through the form above.</p>
                </div>
