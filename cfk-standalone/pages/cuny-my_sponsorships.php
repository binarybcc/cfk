...
/**
 * My Sponsorships - End of Season Version
 * Unified page for accessing sponsorship details when season has ended
 * v1.5 - Reservation System (End of Season)
 */
...
<div class="my-sponsorships-page" x-data="mySponsorshipsApp()">
    ...
    <div class="page-header">
        ...
        <p class="page-description">
            Access your sponsorship details and view the children you've sponsored this season
        </p>
    </div>
                            ...
                            <div class="sponsored-child-card">
                                ...
                                <div class="child-info-grid">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <span><?php
                                        $timestamp = strtotime((string) $sponsorship['confirmation_date']);
                                        echo date('M j, Y', $timestamp !== false ? $timestamp : 0);
                                        ?></span>
                                    </div>
                                </div>
            ...
            <?php else : ?>
                ...
                <div class="lookup-form-container">
                    ...
                    <div class="help-section">
                        ...
                        <p class="season-end-notice"><strong>Note:</strong> The sponsorship period for this season has ended. This page is for accessing existing sponsorship details only.</p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
...
function mySponsorshipsApp() {
    return {
        ...
        init() {
            // Load selections for backward compatibility
