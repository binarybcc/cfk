...
class CFK_Admin {
    ...
    public function init(): void {
        ...
        add_filter('manage_cfk_child_posts_columns', [$this, 'add_child_columns']);
        add_action('manage_cfk_child_posts_custom_column', [$this, 'populate_child_columns'], 10, 2);
        add_filter('manage_edit-cfk_child_sortable_columns', [$this, 'make_child_columns_sortable']);
        ...
        // Bulk actions
        add_filter('bulk_actions-edit-cfk_child', [$this, 'add_bulk_actions']);
        add_filter('handle_bulk_actions-edit-cfk_child', [$this, 'handle_bulk_actions'], 10, 3);
     ...
     * 
     * @since 1.0.0
     * @param string|null $text Current footer text
    ...
    public function admin_footer_text(?string $text): string {
        ...
        if ($screen && (strpos($screen->id, 'christmas-for-kids') !== false || 
                       strpos($screen->id, 'cfk_child') !== false)) {
            return sprintf(
